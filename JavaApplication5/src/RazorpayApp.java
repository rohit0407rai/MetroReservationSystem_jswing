 ...
 * @author Lenovo
 */
public class RazorpayApp extends javax.swing.JFrame {

    /**
     * Creates new form RazorpayApp
     */
    public RazorpayApp() {
        initComponents();
    }
    String User;
    public RazorpayApp(String User) {
        initComponents();
        this.User=User;
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Directing to Razorpay.....");
        ...
        jTextField2.setText("NOTE:-Pls Wait dont log out of screen till payment is not succesful");
        ...
        jButton1.setText("Print Ticket and Logout");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RazorpayApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RazorpayApp().setVisible(true);
            }
        });
    }
